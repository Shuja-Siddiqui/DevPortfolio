...
export const ProjectCard = ({data,projectName,id}) => {

  const navigate = useNavigate();
  const baseURL = process.env.REACT_APP_URL;
  return (
    <div className="w-full flex flex-col justify-center items-center gap-5">
    {data[0] && <div className="w-full p-4 border border-night-black rounded-2xl relative group">
        <div
          className="w-full min-h-[300px] flex justify-center items-start overflow-hidden  rounded-2xl"
          style={{
            backgroundImage: `url(${baseURL}/file/${data[0]})`,
      ...
      <div className="w-full flex flex-col md:flex-row  justify-center items-center gap-3">
        {data[1] && <div className="w-full md:w-[50%]  p-4 border border-night-black rounded-2xl relative group">
          <div
            style={{
        ...
        {data[2] && <div className="w-full md:w-[50%] p-4 border border-night-black rounded-2xl relative group">
          <div
            style={{
      ...
      { data[3] && <div className="w-full p-4 border border-night-black rounded-2xl relative group">
        <div
          className="w-full min-h-[300px] flex justify-center items-start overflow-hidden  rounded-2xl"
          style={{
